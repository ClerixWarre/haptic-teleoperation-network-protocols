...
def generate_launch_description():
    ...
    server_host_arg = DeclareLaunchArgument(
        ...
        description='DCCP server hostname or IP address'
    )
    ...
    # Server node
    dccp_server_node = Node(
        package='dccp_haptic',
        executable='dccp_haptic_server',
        name='dccp_haptic_server',
        output='screen',
        arguments=[
    ...
    dccp_client_node = Node(
        package='dccp_haptic',
        executable='dccp_haptic_client',
        name='dccp_haptic_client',
        output='screen',
        arguments=[
            server_host,
            '--stats-interval=' + stats_interval,
